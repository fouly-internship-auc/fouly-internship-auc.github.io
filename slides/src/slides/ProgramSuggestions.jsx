...
const SUGGESTIONS = [
  ...
  { tag: '02', title: 'Formal optimisation',
    note: 'Convex optimisation, LP, duality. Would have helped both the join-cost work and the clock-fit estimator.' },
  { tag: '03', title: 'Formal verification',
    note: 'The habit of stating a specification before writing code is what design docs are an industrial-grade version of.' },
